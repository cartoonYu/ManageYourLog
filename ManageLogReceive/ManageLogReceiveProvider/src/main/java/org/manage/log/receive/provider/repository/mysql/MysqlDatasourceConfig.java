 ...
 */
@Configuration
@MapperScan(basePackages = MysqlDatasourceConfig.PACKAGE_NAME, sqlSessionTemplateRef = "mysqlTemplate")
...
public class MysqlDatasourceConfig {
    ...
    public static final String PACKAGE_NAME = "org/manage/log/receive/provider/repository/mysql/mapper";
